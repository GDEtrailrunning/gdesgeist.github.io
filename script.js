...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [13, 14, 11, 13, 25], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [10, 10, 10, 8, 14], // Datos de los km recorridos en cada día
...
function actualizarDiasRestantes() {
  // Fecha objetivo fija
  const objetivoDate = new Date('2026-04-10');
